...
#            data = df_data.values
    ...
    def create_normalized_raw_data_features_and_target(self, df, columnNames, n_in, n_out, timeenc):

        raw_data = df[columnNames]
        raw_data = raw_data.reset_index(drop=True)

        raw_data_scaler = StandardScaler()
        raw_data_transformed = raw_data_scaler.fit_transform(raw_data)
        raw_data_lags = self.series_to_supervised(raw_data_transformed.copy(), n_in, n_out)

        return raw_data_lags
