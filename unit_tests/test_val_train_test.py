...
class MyTestCase(unittest.TestCase):
    def test_train_test_val_sets(self):
        ...
        column_names = ["date", "daily_load", "fatigue", "mood", "readiness", "sleep_duration", "sleep_quality", "soreness", "stress"]
    ...
    def test_create_train_test_val_data(self):
        ...
        simulaData.create_train_test_data()
